...
public class PlayerInput
{
    ...
    public bool _issueOrder {get; private set;}

    public PlayerInput()
    {
        // =====================================================================
        // Part of outdated touch controls at bottom of file.
    ...
    private bool issueOrderPressed;
    private void ButtonReader()
    {
        ...
        _issueOrder = issueOrderPressed;

        switchPressed = false;
        reloadPressed = false;
        attackPressed = false;
        attackReleased = false;
        issueOrderPressed = false;
    }
    ...
    /// <summary>
    /// Issue Order button click listener.
    /// </summary>
    private void OnIssueOrder()
    {
        issueOrderPressed = true;
    }    

    // =========================================================================
    // Touch controls that need to be changed if they're to be used.
    // =========================================================================
